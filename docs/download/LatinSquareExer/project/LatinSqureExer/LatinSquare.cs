...
namespace GNPZ_sdk{
    ...
    public partial class LatinSquareGen{
     ...
     // private int LatSqrParaMax = 56*6*6*6*6*6*6;
        private int[,] permList ={{0,1,2},{0,2,1},{1,0,2},{2,0,1},{1,2,0},{2,1,0} };
        private int[,] p123={{1,2,3},{2,3,1},{3,1,2} };
        private int[,] U456789={
        ...
        private int[,] p147 ={{1,4,7},{4,7,1},{7,1,4} };
     ...
     //       PTop = new int[]{16,2,4,4,1,3,3,5};  //for debug
     //       PLft = new int[]{13,2,0,5,3,2,3,0};
        ...
        private void  _LatinSquareSub_02(){
            //PTop[0]:0-9 pmXY:0-5 PTop[1]:0-3(if PTop[0]==0 then PTop[1]=0)
            int nn, cc=0;
            int px=PTop[0]%10;
            int cA=(PTop[0]<10)? 0: 3;
            int cB=3-cA;
        ...
        private void _LatinSquareSub_11( ){
            //PLft[0]:0-9 PLft[2]:0-5 PLft[3]:0-5
            int c=0;
            int px=PLft[0]%10;
        ...
        private void _LatinSquareSub_12( ){
            //PLft[0]:0-9 pmXY:0-5 PLft[1]:0-3(if PLft[0]==0 then PLft[1]=0)
            int nn,rr=0,rs=0;
            int px=PLft[0]%10;
            int rA=(PLft[0]<10)? 0: 3;
            int rB=3-rA;
