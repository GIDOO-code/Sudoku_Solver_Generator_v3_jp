...
namespace GIDOO_space{
    static public class GNPZExtender{
        ...
        static public int DifSet( this int A, int B ){ return (int)(A&(B^0xFFFFFFFF)); } //差集合
        ...
        static public int BitCount( this int nF ){  
            if( (nF&0x7FFFFE00)==0 )  return __BC[nF];  //表参照の方が速い!
        ...
        static public bool IsNumeric( this string st ){
            //文字列がが数値であるかどうかをテスト
            //http://jeanne.wankuma.com/tips/csharp/validation/isnumeric.html
            int nNullable;
            return int.TryParse( st, System.Globalization.NumberStyles.Any,
                null, out nNullable );
        }
        static public bool IsNumeric( this char ch ){
            ...
            //http://jeanne.wankuma.com/tips/csharp/validation/isnumeric.html
            int nNullable;
            return int.TryParse( ch.ToString(), System.Globalization.NumberStyles.Any,
                null, out nNullable );
        }
