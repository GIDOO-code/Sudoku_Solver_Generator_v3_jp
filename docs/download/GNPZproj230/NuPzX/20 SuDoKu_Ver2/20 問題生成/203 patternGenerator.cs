...
namespace GNPZ_sdk{
    public class patternGenerator{
        ...
        public int patternAutoMaker( int patSel ){
            ...
            do{
                ...
                for( nc=0; nc<CellNumMax; ){
                    ...
                    nc = symmetricPattern(patSel,r,c,true);
            ...
            _PatternToBit( ); //(既に設定済みの場合もある。再呼び出し許容）
            return nc;
        }
        public int symmetricPattern( int patSel, int r, int c, bool setFlag ){
            int pat = setFlag? 1: 1-GPat[r,c];
            GPat[r,c] = pat;
            switch(patSel){
                case 0: break;
                case 1: GPat[r,8-c]  =pat; break;
                case 2: GPat[8-r,c]  =pat; break;
                case 3: GPat[8-c,r]  =GPat[8-r,8-c]=GPat[c,8-r]=pat; break;
                case 4: GPat[8-r,8-c]=pat; break;
        ...
        //=====パターン取り込み =====
        public int patternImport( UProblem pGP ){
            int nc=0;
