...
namespace GNPZ_sdk{
    public partial class SDK_Ctrl{
        ...
        static public int rxCTRL=-1;      //=0:新たなパターンで問題候補生成 
        ...
        public bool GenerateLatinSqure2( ref int RX, int[,] LS ){
            ...
            if(RX==8)  while(LSR[RX].nc<=0) RX--;//変動部分が1行空白のとき
            do{
